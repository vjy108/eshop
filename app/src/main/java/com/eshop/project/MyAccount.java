...
import com.eshop.project.AddNewProductActivity;
import com.eshop.project.ApplyForBusinessAccActivity;
import com.eshop.project.ChangePasswordActivity;
import com.eshop.project.MyaddressActivity;
import com.eshop.project.OrderActivity;
import com.eshop.project.R;
import com.eshop.project.UpdateUserDetails;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (currentUser == null) {
            ...
            IV_edit_info.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent=new Intent(MyAccount.this, com.eshop.project.UpdateUserDetails.class);
